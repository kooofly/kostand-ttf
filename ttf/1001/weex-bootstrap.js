...
/***/ function(module, exports, __webpack_require__) {
	...
	var _detection = __webpack_require__(237);
	    ...
	    return new Promise((resolve, reject) => {
	        storage.getItem('user', e => {
	            if (e.result !== 'failed') {
	                ...
	                if (typeof window !== 'object' && loginModule && loginModule.toLogin) {
