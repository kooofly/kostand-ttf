...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/b08ad552a99c3d6a53d0dabbe1339d18', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/b08ad552a99c3d6a53d0dabbe1339d18',undefined,undefined)
	      ...
	      "children": [
	        {
	          ...
	          "attr": {
	            "items": function () {return this.banner.data},
	            "height": function () {return this.banner.height}
	          }
	        },
	        {
	          "type": "panel",
	          ...
	          "children": [
	            {
	              ...
	              "attr": {
	                "items": function () {return this.data},
	                "itemWidth": function () {return 750/3},
	                "itemBorderWidth": "0"
	              }
	            }
	          ]
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    data: {
	        ...
	        panels: [{ title: '便民服务', data: [] }, { title: '账户管理', data: [] }, { title: '商户查询', data: [] }]
	    },
	    created: function created() {
	        var _this = this;
	        ...
	        if ((typeof window === 'undefined' ? 'undefined' : (0, _typeof3.default)(window)) !== 'object') {
	            ...
	            globalEvent.addEventListener("myLocation", function (e) {
	                ...
	                this.nav.leftItemDes = '杭州:' + e.data;
	            });
	        }
	
	        api.fetchBanners().then(function (res) {
	            _this.banner.data = res;
	        });
	
	        api.fetchApps().then(function (res) {
	            _this.formaterDataByGroup(res);
	        });
	    },
	
	    methods: (0, _assign2.default)({
	        formaterDataByGroup: function formaterDataByGroup(apps) {
